...
The third book authored by Michael Crowhurst (2022) with three chapters co-authored with Michael Emslie builds on our previous work of thinking, researching and writing in edgy and novel ways. In this book the focus becomes teaching practice. 'On Pedagogical Spaces, Multiplicity and Linearities and Learning: Before, Between, Beyond' describes and deploys a research method called ‘auto-teach(er)/ing-focused research,’ a research process that aims to document understandings generated by a teacher when that teacher (re)teaches a course. The book demonstrates how this method was applied by the author(s)/researcher(s) within the pedagogical space that is the teaching of a course and the pedagogical space that is the writing of a book, and documents understandings about learning and teaching that emerged. In the book we explore the notion that the pedagogical spaces that teachers and learners inhabit and in which teaching and learning takes place can be physical sites such as schools as well as teaching and learning events and activities. We argue that such pedagogical spaces are complex on account of consisting of an assemblage of often antagonistic elements including various actors, purposes, affects, and practices. The book explores and celebrates the possibilities for teaching and learning and teachers and learners that this diversity affords. For example, we make the case that a diversity of learners deserve a diversity of assessment approaches. The book extends these ideas to make the case that subjects/teachers/learners inhabit, navigate and are constituted within complex pedagogical spaces in a multiplicity of ways that include affective and temporal dimensions. For example, learners can know, be challenged, and have no idea, as well as feel comfort, discomfort, and strange, before, during and after inhabiting, negotiating, and being produced by pedagogical spaces. We make the case for complex thinking about and design of pedagogical spaces where various possibilities of learners and learning can take place, mingle and generate opportunities for expansive thinking, sensing, and doing.  <br>
