...
The third book authored by Michael Crowhurst (2022) with three chapters co-authored with Michael Emslie builds on our previous work of thinking, researching and writing in edgy and novel ways. In this book the focus becomes teaching practice. 'On Pedagogical Spaces, Multiplicity, Linearities and Learning: Before, Between, Beyond' describes and deploys a research method called ‘auto-teach(er)/ing-focused research,’ a research process that aims to document understandings generated by a teacher when that teacher (re)teaches a course. The book demonstrates how this method is applied by the author/researcher within the pedagogical space that is the teaching of a course and the pedagogical space that is the writing of a book, and documents understandings about learning and teaching that emerged. The book explores the notion that pedagogical spaces are complex, and that subjects/learners inhabit, navigate and are produced within them in a multiplicity of ways. This book applies a research method that generates a knowledge product that research practitioners in a variety of settings might find useful to adopt or adapt. <br>
